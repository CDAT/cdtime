...
conda build ${PKG_NAME} -c cdat/label/nightly -c cdat/label/unstable -c conda-forge  --python 2.7
conda build ${PKG_NAME} -c cdat/label/nightly -c cdat/label/unstable -c conda-forge  --python 3.6
