...
class CDTimeComparisons(unittest.TestCase):
    ...
    def teestOperatorRel(self):
        self.assertEqual(self.smallRel,self.smallRel)
        self.assertEqual(self.smallRel,self.smallComp)
    ...
    def teestOperatorComp(self):
        self.assertEqual(self.smallComp,self.smallRel)
